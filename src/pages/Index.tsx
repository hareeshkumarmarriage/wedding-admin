...
type SiteControl = {
  ...
  maintenance?: { enabled?: boolean; title?: string; description?: string };
};
type WeddingSettings = { introEnabled?: boolean; groomName?: string; brideName?: string };
  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        {showIntro && wedding.introEnabled !== false && <IntroVideoOverlay onFinished={() => setShowIntro(false)} />}
      </AnimatePresence>
    </>
  );
};
