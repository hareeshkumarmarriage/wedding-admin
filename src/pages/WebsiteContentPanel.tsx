...
const groups: Record<Child, { title: string; description: string; fields: { key: string; label: string; type?: "text" | "textarea" | "date" | "time" | "number" | "toggle" | "select"; options?: string[]; help?: string }[] }[]> = {
  ...
  navigation: [{ title: "Navigation", description: "Navigation display settings. Section visibility and order are controlled by Section Manager.", fields: [{ key: "navigationSticky", label: "Sticky navigation", type: "toggle" }, { key: "navigationHome", label: "Show Home", type: "toggle" }, { key: "navigationEvents", label: "Show Events / Story link", type: "toggle" }, { key: "navigationGuestbook", label: "Show Guestbook link", type: "toggle" }] }],
};
